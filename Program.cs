    ...
    public class Calculator
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < numbers.Length; i++)
            {
                ...
                {
                    numbers[i]++; // Code goes here to increment numbers[i] by 1
                }
                else
                {
                    numbers[i]--; // Code goes here to decrement numbers[i] by 1
                }
                Console.Write(" " + numbers[i].number);
            }
            Console.WriteLine();
            ...
            for (int i = 0; i < numbers.Length; i++)
            {
                ...
                {
                    Console.WriteLine($"{numbers[i].number} is larger than {numToCompare.number}");
                } else if (numbers[i] < numToCompare)
                {
                    Console.WriteLine($"{numbers[i].number} is smaller than {numToCompare.number}");
                } else
                {
